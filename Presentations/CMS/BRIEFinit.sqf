...
slideArray = ["pics\506thlogo.jpg","slides\CMS\CMS_Structure.paa"]; 
slideIndex = 0;
...
BRIEF1 = player addAction ["Next" call greenText, "Presentations\CMS\BRIEFnext.sqf", [], 99, false, false, ""];  //should be first in action list
BRIEF2 = player addAction ["Previous" call orangeText, "Presentations\CMS\BRIEFprevious.sqf", [], 98, false, false, ""];  //should be second in action list
BRIEF3 = player addAction ["Close Powerpoint" call redText, "Presentations\CMS\BRIEFend.sqf", [], 97, false, false, ""];  //should be last in action list
